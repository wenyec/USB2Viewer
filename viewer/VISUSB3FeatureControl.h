...
#include "VidUSB2IO.h"
//#include "FormattedFile.h" // it gives a error "CFormattedFile redefined". Why is it caused? -- wcheng's note

/////////////////////////////////////////////////////////////////////////////
// CTweetyFeatureControl dialog

class CVISUsb3FeatureControl : public CDialog
{
	// Construction
public:
	CVISUsb3FeatureControl(CVidUSB2Prop *pVidUSB2, bool* PortReady = NULL, CWnd* pParent = NULL);   // standard constructor
...
#ifdef _DEBUG
//	CFormattedFile m_VISDLLTestingFile;  // it's the temperature definition -- wcheng
	int m_intVISDLLTestingIndex;  // it's the temperature definition -- wcheng
#endif
